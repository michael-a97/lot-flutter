...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String passwordError(String error) {
    String _temp0 = intl.Intl.selectLogic(
      error,
      {
        ...
        'weak': 'The password you entered is weak it should contain Capital letters, a Digit, and a Special Character (@\$!%*?&)',
        'other': 'Invalid input.',
      },
    );
    return '$_temp0 ';
  ...
  String confirmPasswordError(String error) {
    String _temp0 = intl.Intl.selectLogic(
      ...
      {
        'empty': 'This field is required',
        'doNotMatch': 'The confirmation password you entered doesn\'t match with the first password',
        'other': 'Invalid input. ',
      },
    );
    return '$_temp0';
  ...
  @override
  String get resendVerificationMessage => 'Didn\'t receive a verification code?';
  ...
  @override
  String get phoneNumberVerificationFailed => 'Phone number verification failed';

  @override
  String get phoneNumberVerificationTimedOut => 'Phone number verification timed out';
