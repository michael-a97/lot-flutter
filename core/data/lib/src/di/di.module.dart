...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    ...
    gh.factory<_i364.AuthenticationRepository>(
        () => _i364.AuthenticationRepositoryImpl(gh<_i59.FirebaseAuth>()));
    gh.lazySingleton<_i24.ApiClient>(
        () => dataModule.apiClient(debug: gh<bool>(instanceName: 'debug')));
    gh.lazySingleton<_i252.AppDatabase>(() => dataModule.appDatabase(
          gh<String>(instanceName: 'dbPath'),
          debug: gh<bool>(instanceName: 'debug'),
        ));
    gh.factory<_i555.AccountRepository>(() => _i555.AccountRepositoryImpl(
          gh<_i24.ApiClient>(),
